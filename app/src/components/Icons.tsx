...
export const LocationIcon = ({ size = 18, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} style={s}>
...
export const BackIcon = ({ size = 18, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} style={s}>
...
export const StarIcon = ({ size = 22, filled = false, color }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={filled ? (color || '#F59E0B') : 'none'} stroke={filled ? 'none' : (color || 'currentColor')} strokeWidth="1.5" style={s}>
...
export const WalkIcon = ({ size = 14, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} style={s}>
