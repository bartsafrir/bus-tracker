...
const OPERATOR_COLORS = {
  // ── Major operators ──
  'אגד':                    { bg: '#008D36', text: '#fff' },  // Egged — green (alef logo)
  'דן':                     { bg: '#00A0E3', text: '#fff' },  // Dan — light blue
  'מטרופולין':              { bg: '#00845D', text: '#fff' },  // Metropoline — green/teal
  ...
  // ── Regional / smaller ──
  'ש.א.מ':                  { bg: '#15803D', text: '#fff' },  // SHA.M — green
  'דן בדרום':               { bg: '#00A0E3', text: '#fff' },  // Dan South — same as Dan
  'גלים':                   { bg: '#0077B6', text: '#fff' },  // Galim — blue
  'תנופה':                  { bg: '#BE185D', text: '#fff' },  // Tnufa — magenta/pink
  'בית שמש אקספרס':         { bg: '#2E5090', text: '#fff' },  // Beit Shemesh Express — blue
